...
/// <summary>
/// Win32 job object configured to kill its members when the last handle closes.
/// The server is a separate process, so without this a crashed or force-killed shell
/// would leave EngineBattle.exe running and its port bound.
/// </summary>
internal sealed class JobObject : IDisposable
{
    ...
    /// <summary>Best effort: on failure the child simply is not tied to the shell.</summary>
